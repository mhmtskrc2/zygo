...
closer to the 1.7 ms above. [The embedder's benchmark](../bench-embed.md) has
the full setup.
...
from 190 ms to 47 ms. [What Zygo costs](../performance.md#python-bytecode)
has the details.
...
services. [The threat model](../threat-model.md) and
[the comparison](../comparison.md#what-zygo-does-not-do) say where the
edges are.
