...
a whole virtual machine (Firecracker, Zygo's `vm` backend); [chapter 10](10-similar-projects.md)
compares them.
...
← [About this book](README.md) · [Contents](README.md) · **Next: [2. Namespaces](02-namespaces.md) →**
