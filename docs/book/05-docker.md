...
defaults point the wrong way. [The comparison](10-similar-projects.md#the-defaults)
...
← [4. The other locks](04-other-locks.md) · [Contents](README.md) · **Next: [6. How Zygo works](06-how-zygo-works.md) →**
