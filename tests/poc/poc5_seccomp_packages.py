...
Run under the profile:
    ...
    docker run --rm --security-opt seccomp=tests/poc/seccomp-default.json \\
        -v "$PWD/tests/poc:/poc:ro" zygo-poc5 python3 /poc/poc5_seccomp_packages.py
"""
...
def main() -> int:
    ...
    if missing_required:
        ...
        print("  → add the syscalls named above to tests/poc/seccomp-default.json and re-run")
        return 1
